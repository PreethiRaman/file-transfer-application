					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								...
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="Source.jsp">Upload </a></li>
                                                                <li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="V_User.jsp">View User </a></li>
                                                                <li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="Status.jsp">File Status </a></li>
