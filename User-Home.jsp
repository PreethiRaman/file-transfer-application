<%-- 
    Document   : User-Home
    Created on : Feb 9, 2019, 4:29:44 PM
    Author     : David
--%>
<%
    try
		...
		<header>
			<div class="container-fluid">
				<div class="header d-md-flex justify-content-between align-items-center py-3 px-xl-5 px-lg-3 px-2">
					<!-- logo -->
					<div id="logo">
						<h1><a class="" href="index.html">IP & URL </a></h1>
					</div>
					<!-- //logo -->
					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								<li><a href="User-Home.jsp" class="active">Home</a></li>
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="Destination.jsp">(IP) Receive File</a></li>
                                                                <li class="mx-lg-4 mx-md-3 my-md-0 my-2">
									<!-- First Tier Drop Down -->
									<label for="drop-2" class="toggle toogle-2"> <span class="fa fa-angle-down" aria-hidden="true"></span>
									</label>
									<a href="#">URLs<span class="fa fa-angle-down" aria-hidden="true"></span></a>
									<input type="checkbox" id="drop-2" />
									<ul>
                                                                            <li><a href="File-Upload.jsp" class="drop-text">File Upload</a></li>
                                                                            <li><a href="View-All-Files.jsp" class="drop-text">View All Files</a></li>
									</ul>
								</li>
					...
					<li>
						<div class="container">
							<div class="w3ls_banner_txt text-right ml-auto pr-xl-0 pr-sm-4 pr-5">
								<h3 class="w3ls_pvt-title text-wh text-uppercase let mb-2">Admin Home</h3>
